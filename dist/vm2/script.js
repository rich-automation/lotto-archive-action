...
const {Script} = require$$2;
const {
	lookupCompiler,
	removeShebang
} = vm2_compiler.compiler;
const {
	transformer
} = vm2_transformer.transformer;
...
script.MODULE_PREFIX = MODULE_PREFIX;
script.STRICT_MODULE_PREFIX = STRICT_MODULE_PREFIX;
script.MODULE_SUFFIX = MODULE_SUFFIX;
script.VMScript = VMScript;
