...
var vm2_builtin = require('./builtin.js');
...
const {VMError} = vm2_bridge.bridge;
const {DefaultFileSystem} = vm2_filesystem.filesystem;
const {makeBuiltinsFromLegacyOptions} = vm2_builtin.builtin;
const {jsCompiler} = vm2_compiler.compiler;
...
function defaultRequire(moduleName) {
	...
	return commonjsRequire(/* webpackIgnore: true */ moduleName);
}
...
resolverCompat.makeResolverFromLegacyOptions = makeResolverFromLegacyOptions;

exports.commonjsRequire = commonjsRequire;
exports.resolverCompat = resolverCompat;
