...
module.exports = eval("require")("./internal/issues");
...
/* harmony import */ var _internal_issues__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(363);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const issue = yield (0,_internal_issues__WEBPACK_IMPORTED_MODULE_1__.findLastPurchaseIssue)();
        ...
        try {
            ...
            _actions_core__WEBPACK_IMPORTED_MODULE_0__.info(`로또 구매에 실패했습니다. ${e}`);
        }
    });
}
run();
